...
// register Lawyer_Landing_Page_Recent_Post widget
function lawyer_landing_page_register_recent_post_widget() {
    register_widget( 'Lawyer_Landing_Page_Recent_Post' );
}
add_action( 'widgets_init', 'lawyer_landing_page_register_recent_post_widget' );

if( !class_exists( 'Lawyer_Landing_Page_Recent_Post' ) ):
 /**
 * Adds Lawyer_Landing_Page_Recent_Post widget.
 */
class Lawyer_Landing_Page_Recent_Post extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			'lawyer_landing_page_recent_post', // Base ID
			__( 'RARA: Recent Post', 'lawyer-landing-page' ), // Name
			array( 'description' => __( 'A Recent Post Widget', 'lawyer-landing-page' ), ) // Args
		);
	}
                    ...
                    <li>
                        <?php if( has_post_thumbnail() && $show_thumb ){ ?>
                            <a href="<?php the_permalink();?>" class="post-thumbnail">
                                <?php the_post_thumbnail( 'lawyer-landing-page-recent', array( 'itemprop' => 'image' ) ); ?>
                            </a>
                        <?php }elseif( ! has_post_thumbnail() && $show_thumb ){ ?>
                            <a href="<?php the_permalink();?>" class="post-thumbnail">
                                <?php lawyer_landing_page_get_fallback_svg( 'lawyer-landing-page-recent' ); ?>
                            </a>
                        <?php } ?>
...
} // class Lawyer_Landing_Page_Recent_Post 
