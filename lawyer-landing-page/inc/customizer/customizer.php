 ...
 */
function lawyer_landing_page_init_customizer_options() {

    global $lawyer_landing_page_options_posts,  $lawyer_landing_page_options_pages;
	global $lawyer_landing_page_option_categories;
...
add_action( 'customize_register', 'lawyer_landing_page_init_customizer_options', 1 );
...
function lawyer_landing_page_customizer_scripts() {
    $array = array( 
        ...
        'nonce'      => wp_create_nonce('lawyer_landing_page_flush_fonts_nonce')
    );
